...
Voxel Count (continuous, not rounded), plus Joshua's 6 log-ellipsoid tensor features.
...
class ResolutionAwareFeatureEngineer:
    ...
    def extract(self, df: pd.DataFrame, voxel_size_mm: Optional[float], fit_scaler: bool) -> pd.DataFrame:
        ...
        # Build features: use VoxelCount (continuous) + Joshua 6. Do NOT include AbsVolume or VoxelSize.
